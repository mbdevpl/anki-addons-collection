...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fmtLabHeader.setText(_translate("Dialog", "<html><head/><body><p>Hi! <span style=\" font-weight:600;\">Glutanimate</span> here :). Thanks for checking out Review Heatmap and some of my other add-ons. I hope you\'ve been enjoying them! </p><p>I hate asking for this, but writing, supporting, and maintaining my projects really takes a lot of time.</p></p>If <span style=\" font-weight:600;\">{ADDON_NAME}</span> or any of my other add-ons has been a valuable asset in your studies, please do consider <span style=\" font-weight:600;\">supporting my work</span> through one of the methods below:</p></body></html>"))
